...
const validarCampo = (expresion, input, campo) => {
    if(expresion.test(input.value)) {
        ...
        document.querySelector(`#grupo__${campo} i`).classList.remove('fa-file-exclamation');
...
formulario.addEventListener('submit', (e) => {
    ...
    if(campos.nombre && campos.correo && campos.password){
        ...
        document.getElementById('.formulario__mensaje').classList('formulario__mensaje-activo');
    }
